...
YUI.add('ez-universaldiscoveryfinderexplorerlevelview', function (Y) {
     ...
     */
    Y.eZ.UniversalDiscoveryFinderExplorerLevelView = Y.Base.create('universalDiscoveryFinderExplorerLevelView', Y.eZ.TemplateBasedView, [Y.eZ.AsynchronousView], {
        events: {
        ...
        render: function () {
            ...
            container.setHTML(this.template({items: itemsJSONified, loading: this.get('loading'),}));
            return this;
        },
        ...
        _fireExplorerNavigate: function (e) {
            var container = this.get('container'),
                nodeLocationId = e.target.get('parentNode').getData('location-id');
